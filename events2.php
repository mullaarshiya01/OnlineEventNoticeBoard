                ...
                <section>
                    <div class="container">
                        ...
                        <div class="col-md-5"><!--image holder with 5 grid column-->
                            <img src="images/b13.jpg" class="img-responsive" width="390" height="260">
                        </div>
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="col-md-5"><!--image holder with 5 grid column-->
                            <img src="images/b1.jpeg" class="img-responsive" width="390" height="260">
                        </div>
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="col-md-5"><!--image holder with 5 grid column-->
                            <img src="images/profile-img3.jpeg" class="img-responsive">
                        </div>
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
            ...
            <div class="row">
                <section>
                    <div class="container">
                        ...
                        <div class="col-md-5"><!--image holder with 5 grid column-->
                            <img src="images/profile-img2.jpeg" class = "img-responsive">
                        </div>
                        <div class="subcontent col-md-6"><!--event content holder with 6 grid column-->
